...
import (
	...
	"github.com/Akiles94/go-test-api/services/user/contexts/auth/application/ports/outbound"
	"github.com/Akiles94/go-test-api/services/user/contexts/auth/domain/models"
...
func (ruc *RegisterUseCase) Execute(ctx context.Context, registerDto dto.RegisterRequestDto) (*dto.RegisterResponseDto, error) {
	...
	userResponse := dto.RegisterResponseDto{
		ID:       user.ID().String(),
		Name:     user.Name(),
